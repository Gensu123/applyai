...
const Sidebar: React.FC<SidebarProps> = ({ setActiveContent }) => {
  ...
  return (
    <div className="relative h-screen"> {/* Make sure this div is relative and full-screen height */}
    ...
    <aside className="border-2 border-r-grey	 flex flex-col h-screen w-64 sticky top-0 bg-transparent dark:bg-gray-800  " aria-label="Sidebar">
      ...
      <div className="flex-1 ">
        ...
        <div className="group flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white relative overflow-hidden cursor-pointer">
          <button onClick={() => handleContentChange('dashboard')} className="z-10 flex items-center w-full h-full">
          ...
          <span className="absolute w-full h-full transition-all duration-300 ease-linear bg-gradient-to-r from-indigo-500 to-purple-500 rounded-md opacity-0 group-hover:opacity-100"></span>
        </div>


        <div className="group flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white relative overflow-hidden cursor-pointer">
          <button onClick={() => handleContentChange('job-recommendations')} className="z-10 flex items-center w-full h-full">
        ...
        <div className="group flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white relative overflow-hidden cursor-pointer">
          <button onClick={() => handleContentChange('application-tracking')} className="z-10 flex items-center w-full h-full">
        ...
        <div className="group flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white relative overflow-hidden cursor-pointer">
          <button onClick={() => handleContentChange('notifications')} className="z-10 flex items-center w-full h-full">
        ...
        <div className="group flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white relative overflow-hidden cursor-pointer">
          <button onClick={() => handleContentChange('resources-tips')} className="z-10 flex items-center w-full h-full">
            <IoIosPaper size={30} className="text-gray-400 group-hover:text-white mr-3"/>
            <span className="relative transition duration-300 ease-in-out group-hover:text-white">
              Resources and Tips
            </span>
