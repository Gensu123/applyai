  ...
  return (
    <div className=" p-8">
      <div className="flex justify-between mb-8">
        ...
        <div className="relative w-full max-w-xs">
          <input
            ...
            className="border border-slate-300 rounded-md w-full py-2 pl-3 pr-10 focus:outline-none focus:ring-primary-500 focus:border-primary-500"
          />
      ...
      <div className="flex flex-wrap items-center gap-6">
        <h1 className="text-lg font-semibold text-slate-800">Filter by:</h1>
        <Select>
          <SelectTrigger className="py-2 pl-3 pr-8 border border-slate-300 rounded-md focus:outline-none focus:ring-primary-500 focus:border-primary-500 w-[283px] sm:w-auto flex-1">
