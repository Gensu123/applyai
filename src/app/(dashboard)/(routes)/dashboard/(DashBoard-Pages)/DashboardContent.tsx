    ...
    <div className="p-8">
      <div className="flex items-center justify-between   rounded-lg">
        <div className="flex items-center space-x-4 flex-grow ">
          ...
          <Image
            ...
            width={187}
            height={187}
            className="rounded-full shadow-black shadow-xl "
          />
          {/* Greeting message */}
          <div className="min-w-0 p-10 ">
            <h2 className="text-5xl font-bold text-slate-700  pb-4">
              Hey, I am Front-end Developer,
            </h2>
            <h3 className="text-4xl text-slate-500  pb-4">
              Based in Brazil 🇧🇷
            </h3>
            <p className="text-slate-700 text-2xl  ">Olivia Simmons</p>
          </div>
        </div>
        {/* Upload button */}
      ...
      <div className="flex justify-center items-center  ">
        <div className="grid grid-cols-2 gap-8">
          {/* Work Experience */}
          <div className="border-2 border-slate-200 rounded-3xl">
