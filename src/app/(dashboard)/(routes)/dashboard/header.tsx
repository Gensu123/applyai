...
const Header = () => {
  return (
    <header className="border-y-2 border-b-slate-50	flex justify-between items-center px-8   h-20 w-full ">
      <h1 className="text-xl font-semibold text-slate-500">
        Welcome,
        <div className="break-normal text-black indent-4 ">Olivia Simmons</div>
      </h1>
