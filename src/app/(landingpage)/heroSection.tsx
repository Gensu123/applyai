    ...
    <div className="flex flex-col items-center justify-center text-black  md:p-12 lg:p-32 ">
      <h1 className="text-2xl md:text-5xl font-bold mb-3" data-aos='fade-up'>
        ...
        <div className="text-3xl md:text-6xl font-bold mb-3 relative inline-block">
          ApplyAI
          <svg className="absolute bottom-0 left-0" width="180" height="18" viewBox="0 0 209 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M0,10 c30,-10 40,20 70,0 s40,-20 70,10 s40,10 80,-10" stroke="#805ad5" strokeWidth="2" fill="none" />
          </svg>
        </div>
      </h1>
      
      <p className="text-sm md:text-lg text-gray-500 mb-4" data-aos='fade-up'>
