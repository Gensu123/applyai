...
const HeroSection = () => {
  ...
  return (
    <div className="flex  pt-32 flex-col items-center justify-center text-black  md:p-20 lg:p-32 ">
      <h1 className="text-2xl md:text-3xl lg:text-5xl font-bold mb-3" data-aos='fade-up'>
        ...
        <div className="text-3xl md:text-6xl font-bold mb-3 relative  ml-2 inline-block  overflow-clip">
          ApplyAI
          <svg className="absolute bottom-0 overflow-hidden left-0" width="180" height="18" viewBox="0 0 209 20" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <p className="text-sm md:text-lg text-gray-500 mb-4  text-center" data-aos='fade-up'>
