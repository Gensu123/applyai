    ...
    <div className="container mx-auto pt-32 p-4 md:p-12 lg:p-44 flex flex-col lg:flex-row items-center justify-between">
      ...
      <div className=" lg:ml-14  pt-20" data-aos="fade-up">
        ...
        <p className="mb-6 text-sm lg:text-2xl ">
          ...
          apply for jobs tailored to your unique skills and preferences. Whether
          you're a seasoned professional or just starting your career, ApplyAI
          empowers you to find the perfect job match effortlessly. Say goodbye
          to endless job listings and hello to personalized job recommendations
